...
<html>
    ...
    <head>
        ...
        <style>
            .tg {
                border-collapse:collapse;border-spacing:0;border-color:#333;
            }
            .tg td {
                font-family:sans-serif;font-size:16px;padding:5px 5px;
                border-style:solid;border-width:1px;overflow:hidden;
                word-break:normal;border-color:#333;color:#444;
                background-color:#7DCDFF;
            }
            .tg th {
                font-family:sans-serif;font-size:16px;font-weight:bold;
                padding:5px 5px;border-style:solid;border-width:1px;
                overflow:hidden;word-break:normal;border-color:#999;
                color:#fff;background-color:#217AB2;
            }
            td {
    ...
    <?php
    /* Desarrollado por: Carlos F. Casilimas Olivar.
     * Programa: Desarrollo web con PHP.
     * Evidencia: Taller “Uso de formularios para transferencia”.
     * 
     * LLamado a los archivos escenario.php y accion.php que contiene las
     * funciones para imprimir el escenario y para enviar las acciones del usuario
     */
    require("escenario.php");
    require("accion.php");
    //El if se ejecuta cuando el usuario envíe la información del formulario.
    ...
    //Se ejecuta el else if cuando el usario borra la información del
    //formulario y cuando se carga la página.
    ...
    <body>
        <table style="margin:auto;">
            <form method="post">
                ...
                <input type="text" name="ListEscenario" value="<?php
                ...
                ?>" style="display:none" />
                <!-- Se crean los inputs que van a capturar la información
                introducida por el usario y las acciones-->
                <tr>
                    <td>Fila: </td>
                    <td>
                ...
                <!-- Radio buttons para la selección de las acciones disponibles. -->
                <tr>
                    <td>Reservar: </td>
                    <td>
                ...
                <tr>
                    <!-- Se muestran los botones con las acciones de enviar la 
                    información o borrar toda la informacion ingresada -->
                    <td>
